...
{
    @Bean
    public ProducerFactory<String, Arrival> arrivalProducerFactory()
    {
    ...
    @Bean
    public KafkaTemplate<String, Arrival> arrivalTemplate()
    {
        return new KafkaTemplate<>(arrivalProducerFactory());
    }
}